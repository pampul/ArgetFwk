...
class BlogPost {
  ...
  /**
   * @OneToMany(targetEntity="BlogPostRevision", mappedBy="blogPost")
   * @OrderBy({"dateAdd" = "DESC"})
   */
  private $blogPostRevisions;
  ...
  public function setBlogPostRevisions($blogPostRevisions) {
    $this->blogPostRevisions = $blogPostRevisions;
  }

  public function getBlogPostRevisions() {
    return $this->blogPostRevisions;
  }

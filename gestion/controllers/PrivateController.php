...
class PrivateController extends ControllerManager {
  ...
  protected function adminsController() {
    ...
    $this->renderView('views/admins.html.twig', array('tableFwk' => $objFwkTable));
  }
  ...
  protected function backupController() {
    ...
    $this->renderView('views/backup.html.twig', array('query' => $cmd, 'env_localhost' => ENV_LOCALHOST, 'link' => $filePath));
  }
  ...
  protected function workshopController() {
    ...
    $this->renderView('views/workshop.html.twig', array('change' => $change, 'configWorkshop' => $configWorkshop));
  }

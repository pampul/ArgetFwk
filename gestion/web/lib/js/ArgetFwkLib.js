...
(function(e){"use strict";e.fn.extend({maxlength:function(t,n){function s(e){var t=e.val(),n=t.match(/\n/g),r=n?n.length:0;return e.val().length+r}function o(e,n,r){var i=true;if(!t.alwaysShow&&r-s(e)>n){i=false}return i}function u(e,t){var n=t-s(e);return n}function a(e){e.css({display:"block"})}function f(e){e.css({display:"none"})}function l(e,n){var r="";if(t.preText){r+=t.preText}r=r+n+t.separator+e;if(t.postText){r+=t.postText}return r}function c(e,n,r,i){i.html(l(r,e));if(e>0){if(o(n,t.threshold,r)){a(i.removeClass(t.limitReachedClass).addClass(t.warningClass))}else{f(i)}}else{a(i.removeClass(t.warningClass).addClass(t.limitReachedClass))}}function h(t){var n=t[0];return e.extend({},typeof n.getBoundingClientRect==="function"?n.getBoundingClientRect():{width:n.offsetWidth,height:n.offsetHeight},t.offset())}function p(e,n){var r=h(e),i=e.offset(),s=e.outerWidth(),o=n.outerWidth(),u=n.width(),a=n.height();switch(t.placement){case"bottom":n.css({top:i.top+r.height,left:i.left+r.width/2-u/2});break;case"top":n.css({top:r.top-a,left:r.left+r.width/2-u/2});break;case"left":n.css({top:r.top+r.height/2-a/2,left:r.left-u});break;case"right":n.css({top:r.top+r.height/2-a/2,left:r.left+r.width});break;case"bottom-right":n.css({top:r.top+r.height,left:r.left+r.width});break;case"top-right":n.css({top:i.top-a,left:i.left+s});break;case"top-left":n.css({top:i.top-a,left:i.left-o});break;case"bottom-left":n.css({top:i.top+e.outerHeight(),left:i.left-o});break;case"centered-right":n.css({top:i.top+a/2,left:i.left+s-o-3});break}}function d(e){return e.attr("maxlength")||e.attr("size")}var r=e("body"),i={alwaysShow:false,threshold:10,warningClass:"badge badge-success",limitReachedClass:"badge badge-important",separator:" / ",preText:"",postText:"",placement:"bottom",validate:false};if(e.isFunction(t)&&!n){n=t;t={}}t=e.extend(i,t);return this.each(function(){var n=e(this),i=d(n),s=e("<span></span>").css({display:"none",position:"absolute",whiteSpace:"nowrap",zIndex:999}).html(l(i,"0"));r.append(s);n.focus(function(){var e=u(n,i=d(n));s.css({zIndex:99999});c(e,n,i,s);p(n,s)});n.blur(function(){s.css("display","none")});n.keyup(function(){var e=u(n,i=d(n)),r=true;if(t.validate&&e<0){r=false}else{c(e,n,i,s)}return r});n.keydown(function(e){var t=u(n,i=d(n));if(t<=0&&e.keyCode!==46&&e.keyCode!==8){return false}})})}})})(jQuery)
...
$(function() {
  ...
  $('input[name="seoTitle"],input[name="seoH1"],textarea[name="seoDescription"]').maxlength({
    alwaysShow: true,
    placement: 'top'
  });
